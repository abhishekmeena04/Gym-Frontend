      ...
      <div className="flex flex-col justify-between max-w-screen-xl w-full items-center ">
        ...
        <div className="flex w-full items-center pt-10 justify-between  flex-col lg:flex-row gap-[10px] lg:gap-6 md:px-2">
          <div className="lg:w-[380px] bg-[#ccdaf71c]  p-6 rounded w-fit flex flex-col gap-[10px]">
            <p>
              <span className="text-[#F3D302] font-[500] "> Personalized </span>
              Fitness
            </p>
            <p className="text-[13.5px] font-extralight md:text-[13px]">
              We understand that every individual has unique fitness goals and
              needs. That&apos;s why we offer personalized fitness solutions
              tailored to each member. Whether you&apos;re aiming to lose
              weight, build muscle, or improve your overall health, our
              experienced trainers will work closely with you to develop a
              customized workout plan that suits your lifestyle and preferences.
            </p>
            <Image
              width={600}
              height={100}
          ...
          <div className="lg:w-[380px] bg-[#ccdaf71c] p-6 rounded w-fit flex flex-col  gap-[10px]">
            <p>
              {" "}
              <span className="text-[#F3D302] font-[500]">Expert </span>{" "}
            ...
            <p className="text-[13.5px] font-extralight md:text-[13px]">
              ...
              Whether you&apos;re new to exercise or a seasoned athlete, our
              trainers are here to challenge you, inspire you, and celebrate
              your progress.
            </p>
            <Image
              width={600}
          ...
          <div className="lg:w-[380px] bg-[#ccdaf71c] p-6 rounded w-fit flex flex-col  gap-[10px]">
            <p>
              {" "}
              <span className="text-[#F3D302] font-[500]">Building </span> a
              Supportive Community
            </p>
            <p className="text-[13.5px] font-extralight md:text-[13px]">
              At The Fitness Icon Gym, we believe that a strong sense of
              community is essential for long-term success in fitness.
              That&apos;s why we foster a supportive and inclusive environment
              where members can connect, motivate each other, and celebrate
              their achievements. From group classes to social events, our gym
